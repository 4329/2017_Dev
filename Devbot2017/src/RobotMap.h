...
public:
	...
	static std::shared_ptr<DoubleSolenoid> transmissionShifterSolenoid1;
	static std::shared_ptr<DoubleSolenoid> transmissionShifterSolenoid2;
	static std::shared_ptr<mindsensors::CANSD540> intakeMotor;
