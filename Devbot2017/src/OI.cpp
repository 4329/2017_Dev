...
OI::OI() {
    ...
    GearHolderPusher.reset(new JoystickButton(robotOperator.get(), Xbox_Button::Right_Bumper));
    ...
    GearHolderPusher->WhenPressed(new ToggleGearHolder());
    shoot->WhenPressed(new Shoot());
    RobotClimb->WhenPressed(new ClimbSequence());
